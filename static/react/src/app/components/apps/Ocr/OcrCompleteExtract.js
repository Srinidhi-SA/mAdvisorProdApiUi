...
export class OcrCompleteExtract extends React.Component {
  ...
  hightlightField = () => {
    if(this.state.heightLightVal!='80' &&document.getElementsByClassName('defaultSelect')[0].classList.value.includes('active'))
    document.getElementsByClassName('defaultSelect')[0].classList.remove('active')
                ...
                <ul className="export" style={{ float: 'right' }} >
                  <li className="dropdown">
                    ...
                    <ul className="dropdown-menu confidence" style={{ left: 195 }} onClick={(e) => this.setState({ heightLightVal: e.target.className }, this.hightlightField)}>
                      ...
                      <li className="defaultSelect active"><a className="80" role="tab" data-toggle="tab">80%</a></li>
            ...
            <div style={{ backgroundColor: '#fff', padding: 15 }}>
              ...
              <Scrollbars id="ocrScroll" style={{ height: 700 }} onScroll={this.imageScroll}>
                <img style={{ height: `${this.props.ocrImgHeight}px`, width: `${this.props.ocrImgWidth}px` }}
                  ...
                  src={this.props.ocrImgPath.includes('http:')?this.props.ocrImgPath.replace('http','https'):this.props.ocrImgPath}
                />
              </Scrollbars>
