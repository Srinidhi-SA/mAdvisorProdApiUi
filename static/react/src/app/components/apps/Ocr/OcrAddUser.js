                       ...
                       {this.props.loaderFlag && !this.props.ocrUserProfileFlag &&
                        ...
                        {this.props.ocrUserProfileFlag && 
                            <div className="ocrSuccess">
                                <img className="wow bounceIn" data-wow-delay=".25s" data-wow-offset="20" data-wow-duration="5s" data-wow-iteration="10" src={STATIC_URL + "assets/images/success_outline.png"} style={{ height: 105, width: 105 }} />
                                <span style={{ color: 'rgb(50, 132, 121)', display: 'block' }}>Uploaded Successfully</span>
                            </div>
                        }
                    </Modal.Body>
                    <Modal.Footer>
