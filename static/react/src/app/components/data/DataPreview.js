      ...
      if(this.props.createSigLoaderFlag){
        ...
        const topInfo = dataPrev.uiMetaData.metaDataUI.map((item,i)=>{
          if(item.display && item.name!="companyNames" && item.name!="timeline"){
            return(
              <div key={i} className="col-md-5ths col-xs-12 data_preview xs-mb-15">
            ...
            if(item.display && (item.name==="companyNames"||item.name==="timeline")){
              return(
                <div key={i} className="stockTopInfo">
                  <div className="col-md-4 col-xs-4">{item.displayName}</div>
                  <div className="col-md-8 col-xs-8 text-right text-info">
          ...
          <div className="side-body">
            ...
            <div className="main-content">
              <div className="row d_preview">
                {topInfo}
                {(this.props.match.path.includes("apps-stock-advisor") || this.props.match.path.includes("apps-stock-advisor-analyze")) && <div className="col-md-5 col-xs-12 stockInfo">{stockInfo}</div>}
                </div>
                <div className="row">
