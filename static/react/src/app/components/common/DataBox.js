...
export class DataBox extends React.Component {
	...
	render() {
		...
		let columnsTemplates = dataBox.map((data,index)=>{
			return (
				<div key={index} className={window.location.pathname.includes("/apps-stock-advisor/") || window.location.pathname.includes("/apps-stock-document-mode/")?"col-md-2 col-sm-6 col-xs-12 bgStockBox stockBox":"col-md-2 col-sm-6 col-xs-12 bgStockBox"}>
