...
export class C3ChartNew extends React.Component{
  ...
  generateChart(){
    ...
    if(this.props.data.subchart!=null && this.props.data.subchart.show){
      if(document.getElementsByClassName("chart"+this.props.classId+"2")[0]!=undefined){
     ...
     switch(chartData.data.type){
      case "bar": 
              myData = {
                  "axis": {
                    "x": {
                      "extent": (chartData.axis.x.extent!=undefined||chartData.axis.x.extent!=null)?chartData.axis.x.extent:null,
      ...
      case "line": 
        ...
        "axis": {
          ...
          "y2": {
            ...
            "tick": {
                "multiline": chartData.axis.y2!=undefined?chartData.axis.y2.tick.multiline:"",
                "format": this.props.selectedL1 === "Trend"?d3.format("%"):d3.format(".2f"),
